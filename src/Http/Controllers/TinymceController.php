 ...
 */
class TinymceController extends Field
{
    protected $view = "tinymce::index";
    ...
    protected $options = [
        ...
        'toolbar' => [
            'undo redo | preview fullscreen | styleselect | fontsizeselect bold italic underline strikethrough forecolor backcolor |  image axupimgs media blockquote removeformat codesample',
    ...
    protected $videoUploadDirectory = 'tinymce/video';
    ...
    protected function formatVideoUrl(string $url)
    {
        return Helper::urlWithQuery(
            $url,
            [
    ...
    public function render()
    {
        $this->addVariables([
            ...
            'images_upload_handler' => "'" . $this->formatUrl('/admin/file/upload') . "'",
            'upurl' => "'" . $this->formatVideoUrl('/admin/video/upload') . "'"
        ]);
